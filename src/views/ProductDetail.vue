    ...
    <div class="page-requirement">
        <mu-container class="container-main">
            <mu-breadcrumbs class="page-breadcrumb">
                ...
                <mu-breadcrumbs-item to="/products">现货</mu-breadcrumbs-item>
                <mu-breadcrumbs-item disabled>产品详情</mu-breadcrumbs-item>
            </mu-breadcrumbs>
            <mu-row gutter>
                <mu-col span="6">
...
export default {
    ...
    mounted() {
        ...
        this.$http.get(`/ic/products/${requirementId}`).then(
            response => {
